...
dirc='Alt5_Top_Positives'
os.makedirs(dirc)
np.savetxt(dirc+'/'+'examples_Alt5_aggregate_splice_pos.txt',exPosSplice,fmt='%s')
np.savetxt(dirc+'/'+'examples_Alt5_aggregate_intron_pos.txt',exPosIntron,fmt='%s')
np.savetxt(dirc+'/'+'examples_Alt5_aggregate_exon_pos.txt',exPosExon,fmt='%s')

dirc='Alt5_Top_Negatives'
os.makedirs(dirc)
np.savetxt(dirc+'/'+'examples_Alt5_aggregate_splice_neg.txt',exNegSplice,fmt='%s')
np.savetxt(dirc+'/'+'examples_Alt5_aggregate_intron_neg.txt',exNegIntron,fmt='%s')
np.savetxt(dirc+'/'+'examples_Alt5_aggregate_exon_neg.txt',exNegExon,fmt='%s')
