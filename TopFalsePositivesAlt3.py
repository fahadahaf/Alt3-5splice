...
#with open('Alt3_Res_Individual_Final_Pattern.pickle') as f:
	res = pickle.load(f)
...
dirc='Alt3_Top_False_Positives'
os.makedirs(dirc)

np.savetxt(dirc+'/'+'examples_Alt3_splice_false_pos.txt',exPosSplice,fmt='%s')
